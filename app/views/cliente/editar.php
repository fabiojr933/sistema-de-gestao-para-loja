<main><br>
    <section id="facts" class="facts">
        <div class="container">
            <div>
                <a href="<?php echo URL_BASE . "cliente/index" ?>" type="submit" class="btn btn-primary">Voltar</a>
            </div><br>
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Nome</label>
                                <input type="text" class="form-control" name="nome" value="<?php echo $dados['descricao'] ?>">
                            </div>
                        </div><br>
                        <div class="row">
